import { OGroupPostRepliesType } from "@/app/apis/replies/oGroupPost/[postid]/[commentid]/[page]/lib";
  ...
  const updatedComments = _post?.comments.map(async (comment) => {
    return {
      ...
      replies: {
        ...
        totalPages: 0,
        totalRows: 0,
        replies: [] as OGroupPostRepliesType,
      },
    };
  });
...
export type oGroupPostCommentType = typeof comments;

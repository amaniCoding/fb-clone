import { OPagePostRepliesType } from "@/app/apis/replies/oPagePost/[postid]/[commentid]/[page]/lib";
  ...
  const updatedComments = _post?.comments.map(async (comment) => {
    return {
      ...
      replies: {
        ...
        totalPages: 0,
        totalRows: 0,
        replies: [] as OPagePostRepliesType,
      },
    };
  });
...
export type oPagePostCommentType = typeof comments;

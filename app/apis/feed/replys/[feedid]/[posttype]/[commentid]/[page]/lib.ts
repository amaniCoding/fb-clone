...
export const getReplies = async (
  ...
  if (feed?.postType === "user" && type === "original") {
    ...
    const updatedReplies =
      _repliesData?.userPost?.oUserPost?.comments[0].replies.map(async (co) => {
        return {
          ...co,
    ...
    return {
      count: _count?.userPost?.oUserPost?.comments[0]._count.replies,
  ...
  if (feed?.postType === "user" && type === "share") {
    ...
    const updatedReplies =
      _repliesData?.userPost?.userSharePost?.comments[0].replies.map(
        async (co) => {
          return {
            ...co,
            gReactions: await commentPreparer.prepareGReactions(co.id),
    ...
    return {
      count: _count?.userPost?.userSharePost?.comments[0]._count.replies,
      result: updatedRepliesData,
    };
  }
  ...
  if (feed?.postType === "page" && type === "original") {
    ...
    const updatedReplies =
      _repliesData?.pagePost?.oPagePost?.comments[0].replies.map(async (co) => {
        return {
          ...co,
          gReactions: await commentPreparer.prepareGReactions(co.id),
        };
    ...
    return {
      count: _count?.pagePost?.oPagePost?.comments[0]._count.replies,
      result: updatedRepliesData,
    };
  }
  ...
  if (feed?.postType === "page" && type === "share") {
    ...
    const updatedReplies =
      _repliesData?.pagePost?.pageSharePost?.comments[0].replies.map(
        async (co) => {
          return {
            ...co,
            gReactions: await commentPreparer.prepareGReactions(co.id),
    ...
    return {
      count: _count?.pagePost?.pageSharePost?.comments[0]._count.replies,
      result: updatedRepliesData,
    };
  }
  ...
  if (feed?.postType === "group" && type === "original") {
    ...
    const updatedReplies =
      _repliesData?.groupPost?.oGroupPost?.comments[0].replies.map(
        async (co) => {
          return {
            ...co,
            gReactions: await commentPreparer.prepareGReactions(co.id),
    ...
    return {
      count: _count?.groupPost?.oGroupPost?.comments[0]._count.replies,
      result: updatedRepliesData,
    };
  }
  ...
  if (feed?.postType === "group" && type === "share") {
    ...
    const updatedReplies =
      _repliesData?.groupPost?.toGroupSharedPost?.comments[0].replies.map(
        async (co) => {
          return {
            ...co,
            gReactions: await commentPreparer.prepareGReactions(co.id),
    ...
    return {
      count: _count?.groupPost?.toGroupSharedPost?.comments[0]._count.replies,
      result: updatedRepliesData,
    };
  }
...
const cc = await getReplies("feedid", "original", "coid", 1, 7);

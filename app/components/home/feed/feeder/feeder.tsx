...
export default function Feeder() {
  ...
  if (error)
    return (
      <div className=" w-full h-27 mt-2 flex items-center justify-center ">
        <div className="flex flex-col space-y-1">
          <p className="text-center font-semibold"> Failed to load items.</p>
          <Link
            className="font-semibold text-xm block text-center px-2 py-1.5 rounded-sm bg-blue-600 text-white"
            href={`/`}
          >
            Reload this page
          </Link>

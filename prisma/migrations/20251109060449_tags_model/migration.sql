...
-- AddForeignKey
ALTER TABLE "UserPost" ADD CONSTRAINT "UserPost_oUserPostId_fkey" FOREIGN KEY ("oUserPostId") REFERENCES "OUserPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserPost" ADD CONSTRAINT "UserPost_userSharePostId_fkey" FOREIGN KEY ("userSharePostId") REFERENCES "UserSharePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "GroupPost" ADD CONSTRAINT "GroupPost_oGroupPostId_fkey" FOREIGN KEY ("oGroupPostId") REFERENCES "OGroupPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GroupPost" ADD CONSTRAINT "GroupPost_toGroupSharePostId_fkey" FOREIGN KEY ("toGroupSharePostId") REFERENCES "ToGroupSharePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OGroupPost" ADD CONSTRAINT "OGroupPost_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PagePost" ADD CONSTRAINT "PagePost_oPagePostId_fkey" FOREIGN KEY ("oPagePostId") REFERENCES "OPagePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PagePost" ADD CONSTRAINT "PagePost_pageSharePostId_fkey" FOREIGN KEY ("pageSharePostId") REFERENCES "PageSharePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Media" ADD CONSTRAINT "Media_userPostId_fkey" FOREIGN KEY ("userPostId") REFERENCES "OUserPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Media" ADD CONSTRAINT "Media_pagePostId_fkey" FOREIGN KEY ("pagePostId") REFERENCES "OPagePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Media" ADD CONSTRAINT "Media_groupPostId_fkey" FOREIGN KEY ("groupPostId") REFERENCES "OGroupPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_userPostId_fkey" FOREIGN KEY ("userPostId") REFERENCES "OUserPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_pagePostId_fkey" FOREIGN KEY ("pagePostId") REFERENCES "OPagePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_groupPostId_fkey" FOREIGN KEY ("groupPostId") REFERENCES "OGroupPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_userPostId_fkey" FOREIGN KEY ("userPostId") REFERENCES "OUserPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_pagePostId_fkey" FOREIGN KEY ("pagePostId") REFERENCES "OPagePost"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_groupPostId_fkey" FOREIGN KEY ("groupPostId") REFERENCES "OGroupPost"("id") ON DELETE SET NULL ON UPDATE CASCADE;
